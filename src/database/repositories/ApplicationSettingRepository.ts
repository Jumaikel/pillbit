...
export class ApplicationSettingRepository {
    static mapRow(row: Record<string, any>): ApplicationSetting {
        return {
            ...
            isVoiceInputEnabled: row.ast_is_voice_input_enabled === 1,
            ...
            notifyLowStock: row.ast_notify_low_stock === 1,
            reminderSnoozeMinutes: row.ast_reminder_snooze_minutes,
            ...
            theme: row.ast_theme,
            defaultLowStockThreshold: row.ast_default_low_stock_threshold,
    ...
    static async update(data: UpdateApplicationSettingDTO): Promise<void> {
        ...
        await db.runAsync(
            ...
            [
                ...
                data.isVoiceInputEnabled !== undefined ? (data.isVoiceInputEnabled ? 1 : 0) : (current.isVoiceInputEnabled ? 1 : 0),
                ...
                data.notifyLowStock !== undefined ? (data.notifyLowStock ? 1 : 0) : (current.notifyLowStock ? 1 : 0),
                data.reminderSnoozeMinutes !== undefined ? data.reminderSnoozeMinutes : current.reminderSnoozeMinutes,
                ...
                data.defaultLowStockThreshold !== undefined ? data.defaultLowStockThreshold : current.defaultLowStockThreshold,
